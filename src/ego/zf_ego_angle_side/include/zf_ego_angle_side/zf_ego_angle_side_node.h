...
#ifndef ZF_EGO_SIDE_NODE_H
#define ZF_EGO_SIDE_NODE_H
...
class EgoAngleSide : public VisionTransBase, public rclcpp::Node {
 public:
  ...
  explicit EgoAngleSide(const rclcpp::NodeOptions &,
                        std::string name = "ego_angle_side");
  ~EgoAngleSide();
