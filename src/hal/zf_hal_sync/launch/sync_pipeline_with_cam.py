...
def launch_setup(context, *args, **kwargs):
    ...
    img_save_path = os.path.join(context.perform_substitution(save_dir), cam_ns)
...
def generate_launch_description():
    ...
    launch_arg_can_interface = DeclareLaunchArgument(
        ...
        default_value='can1 pcan0' # order 5G4T, vehicle, and IPM
        # default_value='can1' # order 5G4T
    )
    ...
    home_dir = os.path.expanduser("~")
    # Define the path to the file you want to save
    file_path = os.path.join(home_dir, "Music/log/", "logtime.txt")
