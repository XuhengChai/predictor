#ifndef ZF_JETSON_BYTE_TRACKER_H
#define ZF_JETSON_BYTE_TRACKER_H

#include "zf_detect_tracking/tracking/zf_track.h"
...
public:
	...
	~BYTETracker();
	std::vector<STrack> update(const std::vector<DetectObject>& objects);
...
#endif // ZF_JETSON_TRACKING_STRACK_H