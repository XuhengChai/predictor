#ifndef ZF_JETSON_TRACKING_STRACK_H
#define ZF_JETSON_TRACKING_STRACK_H

#include <opencv2/opencv.hpp>

#include "zf_detect_tracking/tracking/kalmanFilter.h"
...
class STrack {
 public:
  ...
  std::vector<float> to_xyxyIdConfCls();
  void mark_lost();
  void mark_removed();
  int next_id();
  int end_frame();
