#ifndef ZF_GLOBAL_UTIL_ATOMIC_RW_LOCK_H_
#define ZF_GLOBAL_UTIL_ATOMIC_RW_LOCK_H_
...
#include "zf_global/util/base_rw_lock_guard.h"
...
#endif  // ZF_GLOBAL_UTIL_ATOMIC_RW_LOCK_H_
