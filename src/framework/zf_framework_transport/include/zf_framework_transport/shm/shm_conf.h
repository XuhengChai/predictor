...
#ifndef ZF_TRANSPORT_SHM_SHM_CONF_H_
#define ZF_TRANSPORT_SHM_SHM_CONF_H_
...
private:
  ...
  // Rrwlock size, Byte
  static const uint64_t RWLOCK_SIZE;
  // Message info size, Byte
  static const uint64_t MESSAGE_INFO_SIZE;

  // For message 0-1K
  static const uint32_t BLOCK_NUM_1K;
  static const uint64_t MESSAGE_SIZE_1K;
  // For message 1-10K
...
#endif              // ZF_TRANSPORT_SHM_SHM_CONF_H_
