...
#ifndef ZF_TRANSPORT_SHM_SEGMENT_H_
#define ZF_TRANSPORT_SHM_SEGMENT_H_
...
#include "zf_framework_transport/shm/state.h"
...
protected:
  ...
  virtual bool CreateShm(int shmid) = 0;
  virtual bool OpenShm(int shmid) = 0;
  ...
  key_t key_;// used in xsi_segment
  std::string shm_name_;// used in posix_segment
private:
  bool Remap();
...
#endif // ZF_TRANSPORT_SHM_SEGMENT_H_
